...
2. Upload `trace.zip` as a CI artifact (see Session 17 for the GitHub Actions step).
...
Allure gives tests a persistent HTML report. Full setup is covered in Session 17, but you can start collecting results immediately:

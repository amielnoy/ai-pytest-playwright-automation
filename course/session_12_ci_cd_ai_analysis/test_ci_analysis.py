"""
Session 12 — tests that demonstrate CI-aware patterns.
...
Run:  pytest course/session_12_ci_cd_ai_analysis/ -v -m smoke
      pytest course/session_12_ci_cd_ai_analysis/ -v -m regression
"""
import pytest

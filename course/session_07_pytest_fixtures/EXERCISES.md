...
> ✏️ **Exercises** · [session_07_pytest_fixtures](.) · [Lecture notes](lecture.md)


## ✏️ Exercise 1: Fixture Scope Audit
...
## ✏️ Exercise 2: Create a `yield` Fixture
...
## ✏️ Exercise 3: Remove Hidden Setup

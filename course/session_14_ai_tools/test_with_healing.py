"""
Session 14 — tests that demonstrate self-healing selectors.
...
Run:  pytest course/session_14_ai_tools/test_with_healing.py -v -s
...
def test_login_with_correct_selectors(inventory_page: InventoryPage):
    """Session 8 test still works — good selectors never trigger healing."""

"""
Session 11 conftest — what's NEW vs session 10
─────────────────────────────────────────────
Session 10 had:  heal_tracker, screenshot_on_failure
Session 11 adds: browser_agent  ← wraps run_agent() as a callable fixture
                The agent can drive the browser with plain English goals.

Run:  pytest course/session_11_mcp_agents/ -v

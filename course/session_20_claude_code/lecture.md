# Session 20 — Claude Code Integration for QA
...
- Explain how Claude Code slash commands differ from the `cli.py` approach in Session 5.
...
## Claude Code vs `cli.py` (Session 10)

| | `cli.py` (Session 10) | Claude Code Slash Commands |
|---|---|---|
...
Use `cli.py` in CI (Session 12 pipeline) and slash commands during local development.

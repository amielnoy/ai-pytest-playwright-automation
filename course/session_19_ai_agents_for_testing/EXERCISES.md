...
> ✏️ **Exercises** · [session_19_ai_agents_for_testing](.) · [Lecture notes](lecture.md)


## ✏️ Exercise 1: Write an Agent Input Contract
...
## ✏️ Exercise 2: Generate a Risk-Based Coverage Inventory
...
## ✏️ Exercise 3: Convert One Agent Finding Into Work
...
## ✏️ Exercise 4: Hallucination Check
...
## ✏️ Exercise 5: Human-Owned QA Decisions

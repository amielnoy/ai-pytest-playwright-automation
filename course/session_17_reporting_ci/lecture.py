"""
Session 17 — Allure 3 + GitHub Pages
...
# ── Evolution summary ─────────────────────────────────────────────────────────
FRAMEWORK_EVOLUTION = {
    "Session 3": "+ python_basics/ (helpers for data, parsing, and assertions)",
    "Session 4": "conftest.py + raw Playwright tests (no POM)",
    "Session 5": "+ locator strategy (role, label, text, test id, filtering)",
    "Session 10": "+ pages/ (BasePage, LoginPage, InventoryPage, CartPage, CheckoutPage)",
    "Session 14": "+ tools/ (CLI generator, self-healing, heal-report) + screenshot_on_failure",
    "Session 15": "+ agents/ (browser explorer) + browser_agent fixture",
    "Session 16": "+ analysis/ (failures, flaky) + CI markers + failure_record fixture",
    "Session 17": "+ reporting/ (categories, environment, Allure screenshots)",
    "Session 23": "capstone delivery in the production framework directories",
}

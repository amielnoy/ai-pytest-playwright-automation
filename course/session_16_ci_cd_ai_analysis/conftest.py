"""
Session 16 conftest — what's NEW vs session 15
─────────────────────────────────────────────
Session 15 had:  browser_agent
Session 16 adds: failure_record  ← autouse fixture that writes failed test
                                   data to failures.jsonl for CI analysis.
                pytest_configure ← registers custom markers.

Run:  pytest course/session_16_ci_cd_ai_analysis/ -v
"""
import json
import os
import pathlib

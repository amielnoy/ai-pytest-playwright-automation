"""
Session 16 — tests that demonstrate CI-aware patterns.
...
Run:  pytest course/session_16_ci_cd_ai_analysis/ -v -m smoke
      pytest course/session_16_ci_cd_ai_analysis/ -v -m regression
"""
import pytest

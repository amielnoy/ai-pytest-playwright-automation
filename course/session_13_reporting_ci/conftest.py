"""
Session 13 conftest — what's NEW vs session 12
─────────────────────────────────────────────
Session 12 had:  failure_record, CI markers
Session 13 adds: pytest_configure writes categories.json + environment.properties
...
# ── NEW in session 13 — Allure categories + environment ────────────────────────

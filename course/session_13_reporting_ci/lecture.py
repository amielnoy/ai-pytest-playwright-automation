"""
Session 13 — Allure 3 + GitHub Pages
...
FRAMEWORK_EVOLUTION = {
    ...
    "Session 4": "+ locator strategy (role, label, text, test id, filtering)",
    "Session 6": "+ pages/ (BasePage, LoginPage, InventoryPage, CartPage, CheckoutPage)",
    "Session 10": "+ tools/ (CLI generator, self-healing, heal-report) + screenshot_on_failure",
    "Session 11": "+ agents/ (browser explorer) + browser_agent fixture",
    "Session 12": "+ analysis/ (failures, flaky) + CI markers + failure_record fixture",
    "Session 13": "+ reporting/ (categories, environment, Allure screenshots)",
    "Session 19": "capstone delivery in the production framework directories",
}
